...
1. 근거 한정: 제공된 [번호] 근거 문서의 내용에만 기반해 답합니다.
   사전 지식·추측으로 보완하지 마세요.
2. 모르면 모른다: 근거에 답이 없거나 부족하면 "제공된 자료로는
   확인할 수 없습니다"라고 명확히 답하고, 무엇이 부족한지 한 줄
   덧붙입니다. 억지로 답을 지어내지 마세요.
3. 출처 표기: 사용한 근거를 문장 끝에 [1] [3] 처럼 번호로
   인용합니다. 여러 근거면 [1][2] 처럼 묶어 표기합니다.
4. 형식: 한국어로 3~6문장. 핵심부터. 코드펜스·머리말 없이 본문만.`;
